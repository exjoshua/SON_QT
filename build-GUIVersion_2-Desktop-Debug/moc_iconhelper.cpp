...
#include "../GUIVersion_2/iconhelper.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_IconHelper_t, stringdata) + ofs \
...
const QMetaObject IconHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_IconHelper.data,
      qt_meta_data_IconHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_IconHelper.stringdata))
